...
{
    [TestFixture]
    public class WhenAPayeSchemeIsAdded : EventPublisherServiceTestsBase
    {
        [Test]
        public async Task ThenTheEventIsCreated()
        {
            ...
            Mediator.Verify(x => x.PublishAsync(It.Is<CreateAccountEventCommand>(e => e.ResourceUri == expectedAccountResourceUri && e.Event == "PayeSchemeAdded")), Times.Once);
        }
    }
}
