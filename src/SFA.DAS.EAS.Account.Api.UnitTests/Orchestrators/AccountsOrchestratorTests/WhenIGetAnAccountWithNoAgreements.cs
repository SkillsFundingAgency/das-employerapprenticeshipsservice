...
{
    internal class WhenIGetAnAccountWithNoAgreements : AccountsOrchestratorTestsBase
    {
        ...
        public async Task ThenResponseShouldHaveAccountAgreementTypeSetToUnknown()
        {
            ...
            //Assert
            Assert.AreEqual(AccountAgreementType.Unknown, result.Data.AccountAgreementType);
        }
    }
}
