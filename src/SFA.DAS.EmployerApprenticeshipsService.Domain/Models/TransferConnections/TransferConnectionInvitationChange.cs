...
namespace SFA.DAS.EAS.Domain.Models.TransferConnections
{
    public class TransferConnectionInvitationChange
    {
        ...
        public virtual Data.Entities.Account.Account ReceiverAccount { get; protected internal set; }
        public virtual long? ReceiverAccountId { get; protected set; }
        public virtual Data.Entities.Account.Account SenderAccount { get; protected internal set; }
