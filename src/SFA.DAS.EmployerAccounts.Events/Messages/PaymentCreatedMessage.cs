...
namespace SFA.DAS.EmployerAccounts.Events.Messages
{
    ...
    public class PaymentCreatedMessage : AccountMessageBase
    {
        ...
        public Earning EarningDetails { get; set; }
        public PaymentCreatedMessage()
            : base(0, string.Empty, string.Empty)
        { }

        public PaymentCreatedMessage(string providerName, decimal amount, long accountId, string creatorName, string creatorUserRef)
