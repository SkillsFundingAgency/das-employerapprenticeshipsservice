...
//        
//        [Test]
//        public Task GetAccount_WhenAccountDoesNotExistAndMaxVacanciesIs2AndHasNoPayeScheme_ThenNullIsReturned()
//        {
//            return TestAsync(f => f.ArrangeAccountDoesNotExist().ArrangeMaxNumberOfVacancies(2)
//                    .ArrangeHasNoPayeScheme(),
//                f => f.GetAccount(),
//                (f, r) => f.AssertNullIsReturned(r));
//        }
//
//        [Test]
//        public Task GetAccount_WhenAccountDoesNotExistAndMaxVacanciesIs2AndHasPayeSchemeAndRecruitApiCallSucceedsAndReturnsNoVacancies_ThenNullIsReturned()
//        {
//            return TestAsync(f => f.ArrangeAccountDoesNotExist().ArrangeMaxNumberOfVacancies(2)
...
//
//        [Test]
//        public Task GetAccount_WhenAccountDoesNotExistAndMaxVacanciesIs2AndHasPayeSchemeAndRecruitApiCallSucceedsAndReturnsOneVacancies_ThenNullIsReturned()
//        {
//            return TestAsync(f => f.ArrangeAccountDoesNotExist().ArrangeMaxNumberOfVacancies(2)
//                    .ArrangeHasPayeScheme().ArrangeRecruitApiCallSucceedsAndReturnsOneVacancy(),
//                f => f.GetAccount(),
//                (f, r) => f.AssertNullIsReturned(r));
//        }
//
//        [Test]
//        public Task GetAccount_WhenAccountExistsAndMaxVacanciesIs2AndHasNoPayeScheme_ThenNoVacanciesAreReturned()
//        {
...
//
//        [Test]
//        public Task GetAccount_WhenAccountExistsAndMaxVacanciesIs2AndHasPayeSchemeAndRecruitApiCallFails_ThenVacancyCardinalityIsNotSet()
//        {
//            return TestAsync(f => f.ArrangeAccountExists().ArrangeMaxNumberOfVacancies(2)
...
//
//            // act
//            return await PortalClient.GetAccount(HashedAccountId, MaxNumberOfVacancies, AccountState);
//        }
//
