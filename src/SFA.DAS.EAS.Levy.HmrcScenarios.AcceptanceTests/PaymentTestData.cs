...
namespace SFA.DAS.EAS.Levy.HmrcScenarios.AcceptanceTests2
{
    public class PaymentTestData
    {
        ...
        public void PopulateTestData()
        {
            ...
            StandardPayment = new Payment
            {
                ...
                Amount = 200,
                CollectionPeriod = new NamedCalendarPeriod { Id = PeriodEnd.PeriodEndId, Month = PaymentCollectionDate.Month, Year = PaymentCollectionDate.Year },
            ...
            StandardSFACoInvestmentPayment = new Payment
            {
                ...
                Amount = 90,
                CollectionPeriod = new NamedCalendarPeriod { Id = PeriodEnd.PeriodEndId, Month = DateTime.Now.Month, Year = DateTime.Now.Year },
                TransactionType = TransactionType.Learning,
                EvidenceSubmittedOn = DateTime.Now.AddDays(-5),
                Uln = 123,
                EmployerAccountVersion = "1.0",
        ...
        private Domain.Models.Payments.PeriodEnd GetCurrentMonthPeriodEnd()
        {
            ...
            {
                PeriodEndId = DateTime.Now.ToString("ddmmyyHHMMss"),
