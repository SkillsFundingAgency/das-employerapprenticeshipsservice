...
namespace SFA.DAS.EmployerFinance.Api.UnitTests.Controllers.AccountLevyControllerTests
{
    public class WhenIGetLevyForAnAccountAndPeriod : AccountLevyControllerTests
    {
        ...
        {            
            ...
            var levyResponse = new GetLevyDeclarationsByAccountAndPeriodResponse { Declarations = LevyDeclarationViewsObject.Create(12334, "abc123") };
            Mediator.Setup(
    ...
    public static class LevyDeclarationViewsObject
    {
