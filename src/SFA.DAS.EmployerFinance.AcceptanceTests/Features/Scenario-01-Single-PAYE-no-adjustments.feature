...
Scenario: Month-01-submission
	...
	Then account with id 25 should see a level 1 screen with a balance of 11000 on the 05/2017
...
Scenario: Month-02-submission
	...
	When we refresh levy data for account id 25 paye scheme 123/ABC
	And All the transaction lines in this scenario have had there transaction date updated to their created date
	Then account with id 25 should see a level 1 screen with a balance of 22000 on the 06/2017
...
Scenario: Month-06-submission
	...
	When we refresh levy data for account id 25 paye scheme 123/ABC
	And All the transaction lines in this scenario have had there transaction date updated to their created date
	Then account with id 25 should see a level 1 screen with a balance of 66000 on the 10/2017
	And account with id 25 should see a level 1 screen with a total levy of 11000 on the 10/2017
	And account with id 25 should see a level 2 screen with a levy declared of 10000 on the 10/2017
	And account with id 25 should see a level 2 screen with a top up of 1000 on the 10/2017
...
Scenario: Month-12-submission
	...
	When we refresh levy data for account id 25 paye scheme 123/ABC
	And All the transaction lines in this scenario have had there transaction date updated to their created date
	Then account with id 25 should see a level 1 screen with a balance of 132000 on the 04/2018 
	And account with id 25 should see a level 1 screen with a total levy of 11000 on the 04/2018 
	And account with id 25 should see a level 2 screen with a levy declared of 10000 on the 04/2018 
	And account with id 25 should see a level 2 screen with a top up of 1000 on the 04/2018 
