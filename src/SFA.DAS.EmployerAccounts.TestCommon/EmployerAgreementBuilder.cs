...
namespace SFA.DAS.EmployerAccounts.TestCommon
{
    ...
    public class EmployerAgreementBuilder
    {
        ...
        public List<Models.Account.Account> Accounts { get; }
        ...
        {
            DbSetStub<Models.Account.Account> accountsDbSet = new DbSetStub<Models.Account.Account>(Accounts);
        ...
        public Models.Account.Account GetAccount(long accountId)
        {
