...
{        
    ...
    {
        _logger.LogInformation("Requesting GetAccountTransactions for account {HashedAccountId} from employerFinanceApiService", hashedAccountId);
    ...
    {
        _logger.LogInformation("Requesting AccountTransactionSummary for account {HashedAccountId} from employerFinanceApiService", hashedAccountId);
