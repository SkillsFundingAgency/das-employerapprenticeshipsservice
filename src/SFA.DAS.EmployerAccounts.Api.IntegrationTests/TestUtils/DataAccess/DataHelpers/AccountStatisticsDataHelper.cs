...
namespace SFA.DAS.EmployerAccounts.Api.IntegrationTests.TestUtils.DataAccess.DataHelpers
{
    internal class AccountStatisticsDataHelper
    {
        ...
        {
            _configuration = ConfigurationHelper.GetConfiguration<EmployerAccountsConfiguration>(ServiceName);
        }
