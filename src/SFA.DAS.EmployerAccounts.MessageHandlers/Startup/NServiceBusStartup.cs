...
public class NServiceBusStartup : IStartup
{
    ...
    {
        var employerAccountsConfiguration = _container.GetInstance<EmployerAccountsConfiguration>();

        var endpointConfiguration = new EndpointConfiguration(EndpointName)
            .UseAzureServiceBusTransport(() => employerAccountsConfiguration.ServiceBusConnectionString, _container)
