...
namespace SFA.DAS.EAS.Application.UnitTests.Queries.GetCreatedTransferConnectionTests
{
    public class WhenIGetCreatedTransferConnections
    {
        ...
        private GetCreatedTransferConnectionQueryHandler _handler;
        private readonly GetCreatedTransferConnectionQuery _query = new GetCreatedTransferConnectionQuery { TransferConnectionId = TransferConnectionId };
        ...
        public void SetUp()
        {
            ...
            _handler = new GetCreatedTransferConnectionQueryHandler(_currentUser, _employerAccountRepository.Object, _membershipRepository.Object, _transferConnectionRepository.Object);
        }
        ...
        public async Task ThenShouldReturnCreatedTransferConnections()
        {
            ...
            Assert.That(model, Is.TypeOf<CreatedTransferConnectionViewModel>());
        ...
        {
            _transferConnectionRepository.Setup(r => r.GetCreatedTransferConnection(TransferConnectionId)).ReturnsAsync(null);
