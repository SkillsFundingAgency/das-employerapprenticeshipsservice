...
namespace SFA.DAS.EAS.Application.UnitTests.Queries.GetCreatedTransferConnectionInvitationTests
{
    public class WhenIGetCreatedTransferConnectionInvitations
    {
        ...
        private GetCreatedTransferConnectionInvitationQueryHandler _handler;
        private readonly GetCreatedTransferConnectionInvitationQuery _query = new GetCreatedTransferConnectionInvitationQuery { TransferConnectionInvitationId = TransferConnectionInvitationId };
        ...
        public void SetUp()
        {
            ...
            _handler = new GetCreatedTransferConnectionInvitationQueryHandler(_currentUser, _employerAccountRepository.Object, _membershipRepository.Object, _transferConnectionRepository.Object);
        }
        ...
        public async Task ThenShouldReturnCreatedTransferConnectionInvitation()
        {
            ...
            Assert.That(response, Is.TypeOf<GetCreatedTransferConnectionInvitationResponse>());
        ...
        {
            _transferConnectionRepository.Setup(r => r.GetCreatedTransferConnectionInvitation(TransferConnectionInvitationId)).ReturnsAsync(null);
