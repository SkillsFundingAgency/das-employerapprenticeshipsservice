...
namespace SFA.DAS.EmployerAccounts.Models
{
    public class TransferConnectionInvitation : Entity
    {
        ...
        public TransferConnectionInvitation(Account senderAccount, Account receiverAccount, User senderUser) : this()
        {
        ...
        public void Approve(Account approverAccount, User approverUser)
        {
        ...
        public void Delete(Account deleterAccount, User deleterUser)
        {
        ...
        public void Reject(Account rejectorAccount, User rejectorUser)
        {
        ...
        private void RequiresRejectorAccountIsTheReceiverAccount(Account rejectorAccount)
        {
