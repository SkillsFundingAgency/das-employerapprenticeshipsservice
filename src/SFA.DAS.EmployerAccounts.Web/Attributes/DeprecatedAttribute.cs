...
namespace SFA.DAS.EmployerAccounts.Web.Attributes
{
    ...
    public class DeprecatedAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            Logger.Info($"To track Apprentice V1 details landing on EmployerAccounts.Web: UrlReferrer Request: {referrer} Request to Page: {rawUrl} Handled At: {controllerName}.{actionName}");
