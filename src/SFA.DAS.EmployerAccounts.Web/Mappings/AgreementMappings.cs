    ...
    public class AgreementMappings : Profile
    {
        public AgreementMappings()
        {
            CreateMap<AgreementDto, EmployerAccounts.Models.EmployerAgreement.EmployerAgreementView>()
                ...
                .ForMember(dest => dest.TemplateAgreementType, opt => opt.MapFrom(src => src.Template.AgreementType))
                ...
                .ForMember(dest => dest.AgreementVersion, opt => opt.MapFrom(src => src.Template.VersionNumber));
