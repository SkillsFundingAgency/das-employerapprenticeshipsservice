...
namespace SFA.DAS.EmployerAccounts.Web.ViewModels
{
    public class OrganisationAgreementViewModel
    {
        ...
        public DateTime? AgreementV1SignedDate { get; set; }
        public DateTime? AgreementV2SignedDate { get; set; }
        public DateTime? AgreementV3SignedDate { get; set; }
        ...
        {
            if (employerAgreement != null && employerAgreement.SignedDate.HasValue)
            {
                AgreementV2SignedDate = employerAgreement.SignedDate;
            }
