...
namespace SFA.DAS.EAS.Web.UnitTests.Orchestrators.HomeOrchestratorTests
{
    public class WhenGettingUserAccounts
    {
        ...
        public void Arrange()
        {
            ...
            _mediator.Setup(x => x.SendAsync(It.IsAny<GetUserAccountsQuery>())).ReturnsAsync(new GetUserAccountsQueryResponse {Accounts = new Accounts<Domain.Models.Account.Account>()});
