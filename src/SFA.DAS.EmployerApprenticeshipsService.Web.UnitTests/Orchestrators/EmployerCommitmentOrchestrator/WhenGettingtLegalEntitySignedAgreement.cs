...
namespace SFA.DAS.EAS.Web.UnitTests.Orchestrators.EmployerCommitmentOrchestrator
{
    ...
    public class WhenGettingtLegalEntitySignedAgreement
    {
        ...
        public async Task ShouldCallMediatorToGetLegalEntityAgreementRequest()
        {
            ...
            //Act
            await _employerCommitmentOrchestrator.GetLegalEntitySignedAgreementViewModel("ABC123", "123", "C789");

            //Assert
            _mediator.Verify(x => x.SendAsync(It.Is<GetLegalEntityAgreementRequest>(c => c.AccountId == 123L && c.LegalEntityCode == "123")), Times.Once);
        }
        ...
        public async Task ThenTheViewModelShouldReflectWhetherTheAgreementHasBeenSigned(bool isSigned)
        {
            ...
            //Act
            var result = await _employerCommitmentOrchestrator.GetLegalEntitySignedAgreementViewModel("ABC123", "XYZ123", "C789");
