...
namespace SFA.DAS.EAS.Web.UnitTests.Binders.MessageModelBinderTests
{
    [TestFixture]
    public class WhenIBindAViewModel
    {
        ...
        [Test]
        public void ThenShouldBindMembershipMessageProperties()
        {
        ...
        [Test]
        public void ThenShouldNotBindMessagePropertiesIfContextIsEmpty()
        {
        ...
        [Test]
        public void ThenShouldNotBindMessagePropertiesForUnknownMessageType()
        {
