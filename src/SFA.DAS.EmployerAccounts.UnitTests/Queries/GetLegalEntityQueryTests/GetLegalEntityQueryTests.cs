        ...
        public Task Handle_WhenGettingLegalEntity_ThenShouldReturnLegalEntity()
        {
            return RunAsync(f => f.Handle(), (f, r) => r.Should().NotBeNull()
                .And.Match<GetLegalEntityResponse>(r2 => 
                    ...
                    r2.LegalEntity.Agreements.Any(a => a.TemplateVersionNumber == 1 && a.Status == EmployerAgreementStatus.Signed) &&
                    r2.LegalEntity.Agreements.Any(a => a.TemplateVersionNumber == 2 && a.Status == EmployerAgreementStatus.Pending) &&
