...
namespace SFA.DAS.EmployerAccounts.UnitTests.Queries.GetAccountEmployerAgreementsRemove
{
    public class WhenIValidateTheQuery
    {
        ...
        public void Arrange()
        {
            ...
            _membershipRepository.Setup(x => x.GetCaller("ABC123", "XYZ987")).ReturnsAsync(new MembershipView {Role = (short)Role.Owner});
        ...
        {
            //Arrange
            _membershipRepository.Setup(x => x.GetCaller("ABC123", "XYZ987")).ReturnsAsync(new MembershipView { Role = (short)Role.Viewer });
