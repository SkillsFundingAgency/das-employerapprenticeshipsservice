    ...
    public class UserAornPayeLockServiceTests
    {
        ...
        private static readonly TestData[] TestData = 
        {
            new TestData
            {
                ...
                Expected = new UserAornPayeStatus { IsLocked = false }
            },
            new TestData
            {
                NumberOfPermittedAttempts = 3,
            ...
            new TestData
            {
                ...
                Expected = new UserAornPayeStatus { BeginTime = SeedDateTime.AddMinutes(-5), EndTime = SeedDateTime.AddMinutes(25), IsLocked = true }
            },
            new TestData
            {
                NumberOfPermittedAttempts = 3,
                ...
                Expected = new UserAornPayeStatus { BeginTime = SeedDateTime, EndTime = SeedDateTime.AddMinutes(30), IsLocked = true }
            },
            new TestData
            {
                NumberOfPermittedAttempts = 3,
            ...
            new TestData
            {
                ...
                Expected = new UserAornPayeStatus { BeginTime = SeedDateTime.AddMinutes(-4), EndTime = SeedDateTime.AddMinutes(26), IsLocked = true }
            },
            new TestData
            {
                NumberOfPermittedAttempts = 3,
