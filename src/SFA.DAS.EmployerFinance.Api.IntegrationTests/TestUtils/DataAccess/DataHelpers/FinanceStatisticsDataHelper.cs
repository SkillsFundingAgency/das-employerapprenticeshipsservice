...
namespace SFA.DAS.EmployerFinance.Api.IntegrationTests.TestUtils.DataAccess.DataHelpers
{
    public class FinanceStatisticsDataHelper
    {
        ...
        {
            _configuration = ConfigurationHelper.GetConfiguration<EmployerFinanceConfiguration>(ServiceName);
        }
