...
namespace SFA.DAS.EAS.Web
{
    public class FilterConfig
    {
        ...
        {
            filters.Add(new ValidateFeatureFilter(() => DependencyResolver.Current.GetService<IOperationAuthorisationService>(), () => DependencyResolver.Current.GetService<IAuthorizationService>()));
