...
namespace SFA.DAS.EAS.Web.Controllers
{
    ...
    public class EmployerAccountController : BaseController
    {
        ...
        public async Task<ActionResult> CreateAccount()
        {
            ...
            TempData["successMessage"] = $"You need to <a href=\"{ Url.Action("Index", "EmployerAgreement", new { accountId = response.Data.EmployerAgreement.HashedAccountId }) }\">sign the SFA agreement</a> before you can start spending your levy";

            return RedirectToAction("Index", "EmployerTeam", new { accountId = response.Data.EmployerAgreement.HashedAccountId });
        }
