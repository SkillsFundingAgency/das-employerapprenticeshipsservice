...
namespace SFA.DAS.EAS.Web.Controllers
{
    ...
    public class EmployerTeamController : BaseController
    {
        ...
        {
            var externalUserId = Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName));
        ...
        public async Task<ActionResult> ViewTeam(string hashedAccountId)
        {
            ...
            var response = await _employerTeamOrchestrator.GetTeamMembers(hashedAccountId, Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName)));
        ...
        {
            var response = await _employerTeamOrchestrator.GetNewInvitation(hashedAccountId, Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName)));
        ...
        {
            var response = await _employerTeamOrchestrator.InviteTeamMember(model, Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName)));
        ...
        {
            var userId = Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName));
        ...
        public async Task<ActionResult> Cancel(string invitationId, string email, string hashedAccountId, int cancel)
        {
            ...
            var response =  await _employerTeamOrchestrator.Cancel(email, hashedAccountId, Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName)));
        ...
        {
            var response = await _employerTeamOrchestrator.Resend(email, hashedAccountId, Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName)), name);
        ...
        public async Task<ActionResult> Remove(long userId, string hashedAccountId, string email, int remove)
        {
            ...
            try
            {
                ...
                var response = await _employerTeamOrchestrator.Remove(userId, hashedAccountId, Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName)));
        ...
        {
            var teamMember = await _employerTeamOrchestrator.GetTeamMember(hashedAccountId, email, Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName)));
        ...
        {
            var response = await _employerTeamOrchestrator.ChangeRole(hashedAccountId, email, role, Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName)));
            ...
            var teamMemberResponse = await _employerTeamOrchestrator.GetTeamMember(hashedAccountId, email, Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName)));
        ...
        {
            var invitation = await _employerTeamOrchestrator.GetTeamMember(hashedAccountId, email, Guid.Parse(OwinWrapper.GetClaimValue(ControllerConstants.UserExternalIdClaimKeyName)));
