...
namespace SFA.DAS.EmployerFinance.UnitTests.Queries.GetLatestPendingReceivedTransferConnectionInvitationTests
{
    ...
    public class LatestPendingTransferConnectionInvitationFixture : FluentTestFixture
    {
        ...
        public EmployerFinance.Models.Account.Account SenderAccount { get; set; }
        public EmployerFinance.Models.Account.Account ReceiverAccount { get; set; }
        ...
        public LatestPendingTransferConnectionInvitationFixture()
        {
            ...
            SenderAccount = new EmployerFinance.Models.Account.Account
            {
                Id = 1,
                Name = "Sender"
            };

            ReceiverAccount = new EmployerFinance.Models.Account.Account
            {
                Id = 2,
                Name = "Receiver"
            };
