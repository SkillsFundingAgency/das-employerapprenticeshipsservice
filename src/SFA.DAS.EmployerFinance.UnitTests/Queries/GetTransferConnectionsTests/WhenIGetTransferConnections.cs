...
namespace SFA.DAS.EmployerFinance.UnitTests.Queries.GetTransferConnectionsTests
{
    ...
    public class WhenIGetTransferConnections
    {
        ...
        private EmployerFinance.Models.Account.Account _senderAccount1;
        private EmployerFinance.Models.Account.Account _senderAccount2;
        ...
        public void Arrange()
        {
            ...
            _senderAccount1 = new EmployerFinance.Models.Account.Account
            {
                Id = 111111,
                HashedId = "ABC123",
            ...
            _senderAccount2 = new EmployerFinance.Models.Account.Account
            {
                Id = 222222,
                HashedId = "DEF456",
