...
namespace SFA.DAS.EmployerFinance.UnitTests.Queries.GetTransferRequestsTests
{
    ...
    public class WhenIGetTransferRequests
    {
        ...
        private EmployerFinance.Models.Account.Account _account1;
        private EmployerFinance.Models.Account.Account _account2;
        ...
        public void Arrange()
        {
            ...
            _account1 = new EmployerFinance.Models.Account.Account
            {
                Id = 111111,
                HashedId = "ABC123",
                Name = "Account 1"
            ...
            _account2 = new EmployerFinance.Models.Account.Account
            {
                Id = 22222,
                HashedId = "ZYX987",
                Name = "Account 2"
            ...
            _accounts = new List<EmployerFinance.Models.Account.Account>
            {
                _account1,
                _account2
            };
