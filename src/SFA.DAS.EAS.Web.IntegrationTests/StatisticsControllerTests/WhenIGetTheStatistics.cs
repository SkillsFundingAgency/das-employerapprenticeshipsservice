...
namespace SFA.DAS.EAS.Account.API.IntegrationTests.StatisticsControllerTests
{
    ...
    public class WhenIGetTheStatistics
    {
        ...
        public async Task Setup()
        {
            ...
            {
                //todo: this does not need the using as it currently stands.
                using (var connection = new SqlConnection(_apiTester.LevyDeclarationProviderConfiguration.DatabaseConnectionString))
                {
                    connection.Open();
                    ...
                    // todo: get hold of the trans and commit it.
                }
